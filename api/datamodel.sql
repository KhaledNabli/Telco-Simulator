...
-- Datenbank: `iot_demo`
--
CREATE USER 'iot_demo'@'localhost' IDENTIFIED BY 'CXfmZqwVzDpfzTKJ';
GRANT USAGE ON *.* TO 'iot_demo'@'localhost' IDENTIFIED BY 'CXfmZqwVzDpfzTKJ' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
CREATE DATABASE IF NOT EXISTS `iot_demo`;
GRANT ALL PRIVILEGES ON `iot_demo`.* TO 'iot_demo'@'localhost';
